...
class Assignment4Tests(unittest.TestCase):
    ...
    #         self.check_string(err.getvalue(), [
    #                 "test_false: FAIL: RuntimeError Aaaaaaaah!!!\nFalse Test Test\n",
    #                 "test_true: PASS\n\n"])

    # @ignore_warnings
    # def test_module_test_noncallable(self):
    #     assignment4_tests_testfuncs = self.get_module("assignment4_tests_testfuncs")
    #     with captured_output() as (_, err):
    #         assignment4.module_test(assignment4_tests_testfuncs)
    #     self.check_string(err.getvalue(), [
    #             "test_power: PASS\nTest power operator"])
    #     self.assertNotIn(err.getvalue(), "test_name")

    # @ignore_warnings
    # def test_module_test_callable_nonfunc(self):
    #     assignment4_tests_testfuncs = self.get_module("assignment4_tests_testfuncs")
    ...
    #     ff = FakeFunc()
    #     ff.__doc__ = "Fake"
    #     ff.__name__ = "test_fake"
    #     setattr(assignment4_tests_testfuncs, "test_fake", ff)
    #     delattr(assignment4_tests_testfuncs, "test_name")
    #     with captured_output() as (_, err):
    #         assignment4.module_test(assignment4_tests_testfuncs)
    #     self.check_string(err.getvalue(), [
    #             "test_power: PASS\nTest power operator",
